...
<head>
    ...
    <title>Storage Mart | IT — Create Ticket</title>
...
<div id="wrapper">
    ...
    <div class="container-fluid ticket-create-page">
        <div class="page-hero">
            ...
            <p>File a support request linked to an asset. Employee and asset details are shown for reference.</p>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-xl-8">
                <div class="card shadow mb-4 ticket-form-card">
                    ...
                    <div class="card-body">
                        <?php
                        $formAction = htmlspecialchars($base) . '/it/assets/file_ticket';
                        $cancelUrl = htmlspecialchars($base) . '/it/assets';

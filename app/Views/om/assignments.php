...
<head>
    ...
    <title>Storage Mart | Assignments</title>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">
                    <h6 class="m-0 font-weight-bold text-white">All Employee-AOM Assignments</h6>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                <?php if (!empty($assignments)): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($assignment['branch_name'] ?? 'N/A') ?></td>
                                        ...
                                        <td>
                                            <a href="<?= htmlspecialchars($base) ?>/om/edit-assignment?id=<?= $assignment['assignment_id'] ?>" 
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center text-gray-500">No assignments found</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>

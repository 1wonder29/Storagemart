    ...
    ?>
        <div class="container-fluid">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">AOM Branch Assignments</h1>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">
                    <h6 class="m-0 font-weight-bold text-white">Area Operation Managers</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4" class="text-center text-gray-500">No active AOM accounts found</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>

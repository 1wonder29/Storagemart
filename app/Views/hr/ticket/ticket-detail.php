                ...
                <div class="col-lg-8">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <p><strong>Employee:</strong> <?php echo htmlspecialchars(trim((string) ($ticket['emp_firstname'] ?? $ticket['employee_firstname'] ?? '') . ' ' . ($ticket['emp_lastname'] ?? $ticket['employee_lastname'] ?? ''))); ?></p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (($ticket['status'] ?? '') === 'Resolved'): ?>
                            <div class="mb-3">
                                <a href="<?= htmlspecialchars($base) ?>/hr/tickets/download-record?id=<?= (int)($ticket['ticket_id'] ?? 0) ?>" class="btn btn-info btn-block btn-sm">
                            ...
                            <div>
                                <a href="<?= htmlspecialchars($base) ?>/hr/tickets" class="btn btn-block btn-secondary btn-sm">

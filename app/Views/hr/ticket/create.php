...
<div id="wrapper">
    ...
    <div class="container-fluid ticket-create-page">
        <div class="page-hero">
            ...
            <p>File a ticket for a branch. Leave employee blank to file under your HR account, or select a staff member.</p>
        </div>
                        ...
                        <form method="POST" action="<?= htmlspecialchars($base) ?>/hr/tickets/create">
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">Choose the branch this ticket relates to.</small>
                                </div>
    ...
    $('#branch_id').on('change', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                var options = '<option value="">-- Default: yourself (HR account) --</option>';
                if (response.data && response.data.length > 0) {
                    response.data.forEach(function (employee) {
                        var pos = employee.position ? ' (' + employee.position + ')' : '';

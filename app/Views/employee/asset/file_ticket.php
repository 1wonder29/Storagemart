...
<head>
    ...
    <title>Storage Mart | Employee — Create Ticket</title>
...
<div id="wrapper">
    ...
    <div class="container-fluid ticket-create-page">
        <div class="page-hero">
            ...
            <p>File a support request for your assigned asset. Your employee and branch details are pre-filled below.</p>
        </div>
        ...
        <div class="row">
            <div class="col-lg-9 col-xl-8">
                <div class="card shadow mb-4 ticket-form-card">
                    ...
                    <div class="card-body">
                        <?php
                        $formAction = htmlspecialchars($base) . '/employee/assets/file_ticket';
                        $cancelUrl = htmlspecialchars($base) . '/employee/assets';
